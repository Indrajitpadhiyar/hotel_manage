...
<div class="flex flex-col items-center  max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
   <Title  title='Stay Inspired' subTitle='join our newletter and be the frist to discover new destinations,
   exclisive offers,and travel inspiration.'/>
...
<img src={arrow} alt='arrowicon' className='w-3.5 invert group-hover:translate-x-1 
ransition-all' />
            </button>
    </div>
